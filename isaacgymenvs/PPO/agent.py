...
class PPO:
    def __init__(self, obs_dim, act_dim, num_envs, device) -> None:
        ...
        self.actor_optimizer = torch.optim.Adam(Actor.parameters(), lr=0.0026, eps=1e-5)
    ...
    def train(self, obs, actions, next_obs, next_done, logprobs, rewards, dones, values):
        ...
        returns, advantages = self.getGAE(next_obs, next_done, rewards, dones, values)
        ...
        for epoch in range(self.update_epochs):
            ...
            for start in range(0, self.batch_size, self.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue = self.actor(b_obs[mb_inds], b_actions[mb_inds])
