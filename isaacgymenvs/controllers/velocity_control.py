...
import torch
from isaacgymenvs.controllers.rotation_conversions import quaternion_to_matrix, matrix_to_euler_angles, euler_angles_to_matrix
from isaacgymenvs.controllers.math_control import * 
...
class LeeVelocityController:
    ...
    def __call__(self, robot_state, command_actions):
        ...
        vehicle_frame_transforms = euler_angles_to_matrix(
        ...
        rotation_matrix_desired = euler_angles_to_matrix(
