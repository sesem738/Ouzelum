...
class PPO:
    ...
    def train(self, obs, actions, next_obs, next_done, initial_lstm_state, logprobs, rewards, dones):
        ...
        for epoch in range(self.update_epochs):
            ...
            for start in range(0, self.num_envs, envsperbatch):
                ...
                _, newlogprob, entropy, _ = self.actor(b_obs[mb_inds], (initial_lstm_state[0][:, mbenvinds], initial_lstm_state[1][:, mbenvinds]), b_dones[mb_inds], b_actions[mb_inds])
