...
if __name__=="__main__":
    ...
    writer = SummaryWriter(f"../runs/PPO_LSTM_{args.POMDP}_{args.pomdp_prob}")
    ...
    print("\n------------------------------------\n")
    print(f"PPO_LSTM_{args.POMDP}_{args.pomdp_prob}")
    ...
    while global_step <= args.total_steps:
        ...
        if mean_rewards > max_reward:
            ...
            agent.save(f'./checkpoints/PPO_LSTM_best_{args.POMDP}_{args.pomdp_prob}')
    
    print("Max Reward: ", max_reward)
    agent.save(f"./checkpoints/PPO_LSTM_{args.POMDP}_{args.pomdp_prob}")
    writer.close()
